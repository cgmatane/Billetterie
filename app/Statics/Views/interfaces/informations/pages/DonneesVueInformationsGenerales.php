...
class DonneesVueInformationsGenerales extends DonneesVueInformations
{
    public function __construct()
    {
        ...
        $this->setDonneeVue('contenu', '<h3> À savoir avant de partir :</h3>
            <ul>
                <li> <p class="font-weight-bold">Les traverses sont soumises aux conditions climatiques :</p><p>Elles peuvent donc êtres annulées à tout moment <br>
                    En cas d\'annulation, ne vous inquiétez pas vous serez remboursé automatiquement !
                    Plus d\'infos sur le site de <a href="https://meteo.gc.ca/city/pages/qc-15_metric_f.html">Québec météo</a></p></li>
                
                <li><p class="font-weight-bold"> Vous devez vous présenter à l\'embarquement 15 min avant l\'heure de départ</p></li>
            </ul>');
    }
}
