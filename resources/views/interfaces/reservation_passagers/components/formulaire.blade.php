<form class="text-center border border-light p-5 mt-5 mb-5" method="post" action="/reservation_passagers"
    ...
    <fieldset class="form-group passager" id="passager" style="border: #1b1e21 dashed thin;display: none;">
        <div class="row p-0 m-2">
            ...
            <input name="nom" type="text" class="form-control champNom col-sm-5" id="champNom"
                   style="border-width:medium" placeholder="{{ $reservation_passagers_nom }}">
            <input name="prenom" type="text" class="form-control champPrenom col-sm-5" id="champPrenom"
                   style="border-width:medium" placeholder="{{ $reservation_passagers_prenom }}">
            <select name="age" class="browser-default custom-select champAge col-sm-2" id="champAge">
