...
<div class="container">
    ...
    <div class="text-center row justify-content-center">
        ...
        <h4 class="text-center mt-3">Choisissez votre destination/heure de départ</h4>
            ...
            <a href="{{ route('reservation_choix_vehicule') }}"><button type="button" class="btn btn-success col-6 mt-5 p-3" >Baie-Comeau : 10h45</button></a>
            <a href="{{ route('reservation_choix_vehicule') }}"><button type="button" class="btn btn-success col-6 mt-5 p-3" >Baie-Comeau : 13h00</button></a>
            <a href="{{ route('reservation_choix_vehicule') }}"><button type="button" class="btn btn-success col-6 mt-5 p-3" >Baie-Comeau : 15h30</button></a>
        </div>
    </div>
