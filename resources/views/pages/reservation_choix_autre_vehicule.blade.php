...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h4 class="text-center text-warning p-4 font-weight-bold">De quel type est votre véhicules ?</h4>
        </div>
    </div>
    <div class="row text-center">
        <a href="index.php?page=reservation_poids" class="bg-white rounded-sm col-5 ml-1 mx-auto pb-5 pt-5 display-4"
