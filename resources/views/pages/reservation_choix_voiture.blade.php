...
<div class="container">
    ...
    <div class="row text-center">
        <a href="index.php?page=reservation_choix_remorque" class="bg-white rounded-sm col-5 ml-1 mx-auto pb-5 pt-5 display-4"
           style="height: 200px; text-decoration:none;">OUI</a>

        <a href="index.php?page=reservation_choix_autre_vehicule" class="bg-white rounded-sm col-5 ml-1 mx-auto pb-5 pt-5 display-4"
