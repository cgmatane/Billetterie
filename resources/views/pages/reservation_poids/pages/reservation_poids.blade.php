...
<div class="container">
    ...
    <div class="row text-center">
        <a href="{{ route('reservation_matieres') }}" class="bg-white rounded-sm col-5 ml-1 mx-auto pb-5 pt-5 display-4"
    ...
    <div class="row text-center justify-content-center">
        <a href="{{ route('reservation_choix_voiture') }}"><button type="button" class="btn btn-warning mt-5 mb-5 px-5 py-lg-3 py-xs-2">
